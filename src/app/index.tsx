...
const index = () => {
  return (
    <ScrollView contentContainerStyle={{ flexGrow: 1 }}> {/* Added ScrollView for scrollable content */}
      <View>
        <Image 
        ...
        <Link href="components/RegistrationSuccessful" asChild>
          <Pressable className='bg-orange-500 p-4 rounded-lg ml-10 mr-10'>
            <Text className='text-white text-center'>Open Registration Successful Screen</Text>
          </Pressable>
        </Link>
      </View>
    </ScrollView>
